 ...
 * @author ASUS
 */
public class RegistroPDoctor extends javax.swing.JFrame {

    /**
     * Creates new form CrearCuenta
     */
    public RegistroPDoctor() {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnGenerarCurp.setBackground(new java.awt.Color(0, 51, 102));
        ...
        BTNGENERARRFC.setBackground(new java.awt.Color(0, 51, 102));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(cboLlegada, javax.swing.GroupLayout.PREFERRED_SIZE, 285, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnRegresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegresarActionPerformed
        verPacientes in = new verPacientes();
        in.setVisible(true);
        this.dispose();
    ...
    private void btnGuardarRActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarRActionPerformed
        ...
        String llegada = cboLlegada.getSelectedItem().toString();
        ...
        if (!controlPaciente.existePaciente(txtRFC.getText().trim())) {
            ...
            paciente.setModoLlegada(llegada);
...
//Falta agregar restriccion para que no hayan campos vacios.
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistroPDoctor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistroPDoctor().setVisible(true);
            }
        });
    }
